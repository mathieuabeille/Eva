...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { adress: @salon.adress, email: @salon.email, first_name: @salon.first_name, last_name: @salon.last_name, phone: @salon.phone, postal_code: @salon.postal_code, salon: @salon.salon } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { adress: @salon.adress, email: @salon.email, first_name: @salon.first_name, last_name: @salon.last_name, phone: @salon.phone, postal_code: @salon.postal_code, salon: @salon.salon } }
